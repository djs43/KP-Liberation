...
KP_liberation_commander_actions = [
    "76561198212369783",			//Dan
	"76561198043859702"				//McCann
];
...
KPLIB_transportConfigs = [
	...
	["LM_OPCAN_D77_U_MC_CGC", -10, [0,6,-2.3],[0,4.5,-2.3],[0,3,-2.3],[0,1.5,-2.3],[0,6,-1.1],[0,4.5,-1.1],[0,3,-1.1],[0,1.5,-1.1]],				//Pelican 8 crates
	["LM_OPCAN_HOG_RC_MC_WDL",-5,[0,-3,-1]],																													//Recovery Hog
	["LM_OPCAN_HOG_RC_AR_DES",-5,[0,-3,-1]],																													//Recovery Hog Desert
